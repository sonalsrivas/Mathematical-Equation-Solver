...
def FindTopic(s):
    ...
    df=pd.read_csv('E:\\data.csv', header=None, encoding='latin')
    print(df.head())
    df.columns=['SNo','Question','Topic']
    ...
    '''
    X_train, X_test, y_train, y_test = train_test_split(df['Question'], df['Topic'], random_state = 0)
    ...
    return clf.predict(count_vect.transform([s]))
...
map_UNIT_unit={'kmph':['kmph','km/h','km/hr'],'mps':['mps','m/s','m/sec'],'C':['celsius','centigrade','c','degree'],'F':['f','fahrenheit'],
               ...
               'meter':['m','meter','metre'],'kilometer':['kilometre','kilometer','km'],'mps2':['mps2','m/s2']}
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(578, 558)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.GetProblem = QtWidgets.QTextEdit(self.centralwidget)
        self.GetProblem.setGeometry(QtCore.QRect(30, 70, 511, 141))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        font.setBold(False)
        font.setWeight(50)
        self.GetProblem.setFont(font)
        self.GetProblem.setObjectName("GetProblem")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(120, 20, 341, 31))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        ...
        self.line.setGeometry(QtCore.QRect(20, 270, 551, 16))
        self.line.setFrameShape(QtWidgets.QFrame.HLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setGeometry(QtCore.QRect(120, 320, 81, 16))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label_2.setFont(font)
        self.label_2.setObjectName("label_2")
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(140, 390, 51, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label_3.setFont(font)
        self.label_3.setObjectName("label_3")
        self.label_4 = QtWidgets.QLabel(self.centralwidget)
        self.label_4.setGeometry(QtCore.QRect(120, 460, 71, 16))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label_4.setFont(font)
        self.label_4.setObjectName("label_4")
        self.pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton.setGeometry(QtCore.QRect(250, 230, 91, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.pushButton.setFont(font)
        self.pushButton.setObjectName("pushButton")
        self.PutEquation = QtWidgets.QLineEdit(self.centralwidget)
        self.PutEquation.setGeometry(QtCore.QRect(230, 310, 281, 31))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(14)
        self.PutEquation.setFont(font)        
        self.PutEquation.setObjectName("PutEquation")
        self.PutTopic = QtWidgets.QLineEdit(self.centralwidget)
        self.PutTopic.setGeometry(QtCore.QRect(230, 380, 281, 31))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(14)
        self.PutTopic.setFont(font)
        self.PutTopic.setObjectName("PutTopic")
        self.PutSolution = QtWidgets.QLineEdit(self.centralwidget)
        self.PutSolution.setGeometry(QtCore.QRect(230, 450, 281, 31))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(14)
        self.PutSolution.setFont(font)
        self.PutSolution.setObjectName("PutSolution")
        ...
        self.pushButton.clicked.connect(self.integrate)


    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "MainWindow"))
        self.label.setText(_translate("MainWindow", "Mathematical Word Problem Solver"))
        self.label_2.setText(_translate("MainWindow", "Equation :"))
        self.label_3.setText(_translate("MainWindow", "Topic :"))
        self.label_4.setText(_translate("MainWindow", "Solution :"))
        self.pushButton.setText(_translate("MainWindow", "Solve"))

    def integrate(self):
        #string=str(self.WordProblem_textEdit)
        string=self.GetProblem.toPlainText()
        print("string",string)
        TOPIC = FindTopic(string)
        print("TOPIC",TOPIC)
        ...
        self.PutEquation.setText(EQUI+'=0')
        self.PutTopic.setText(TOPIC[0])
        ...
        if curunit!=unknownUnit:
          ...
          self.PutSolution.setText(str(FinalAnswer_PU)+' '+unknownUnit)
          #self.unit_lineEdit_3.setText(unknownUnit)
        else:
          self.PutSolution.setText(str(FinalAnswer)+' '+unknownUnit)
          #self.unit_lineEdit_3.setText(unknownUnit)
